...
# Contents:
Beta Models.json - Installs hex-codes from TCRF to install unused models to the SM64 ROM.

Remove Chain Chomp's Log.json - entriely by SDM2. Removes the log that Chain Chomp is attached to, results into it looking like in the beta.
